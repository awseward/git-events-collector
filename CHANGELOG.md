...
## [Unreleased]
### Removed
- Shims (`gec_*`) which provided backwards compatibility for `gec` (https://github.com/awseward/git-events-collector/pull/64)

## [0.4.4] 2021-12-15
### Changed
- Finish `gec` consolidation by consolidating `gec_path` into `gec` (https://github.com/awseward/git-events-collector/pull/63)
